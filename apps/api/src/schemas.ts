...
export const bodySchemas = { RegisterOptionsBody, RegisterBody, LoginOptionsBody, LoginVerifyBody, XdrBody, AuthorizeBuildBody, OnrampBody, BankTransferBody, OfframpBody, AmountBody, PolicyBody, RulesBody, PayBody, PayBodyV2, QuoteBody, CreateTokenBody, EvmTransferBody, Event: EventSchema, Error: ErrorSchema };
