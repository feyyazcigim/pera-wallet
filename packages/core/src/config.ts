...
export const EnvSchema = z.object({
  ...
  /** Smallest CCTP bridge when a Base payment finds the Base wallet short. 0 = bridge exactly the shortfall (every Base payment waits 1–3 min for CCTP); e.g. 1 = keep a float so the next ones are instant. */
  BASE_BRIDGE_MIN_USDC: DecimalUsdc.default("0"),
